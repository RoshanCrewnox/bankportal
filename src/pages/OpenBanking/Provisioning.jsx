        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
             ...
             <div className="flex flex-1 justify-end items-center gap-3">
                 ...
                 <button 
                    ...
                    className="flex items-center gap-2 bg-primary-orange hover:bg-primary-orange/90 text-white px-4 py-2 rounded-lg font-semibold transition-all shadow-lg shadow-primary-orange/20 whitespace-nowrap"
                >
                    <Plus className="w-4 h-4" />
                    Onboard {activeTab === "TPP" ? "TPP" : activeTab === "Products" ? "Product" : activeTab === "APIs" ? "API" : "Customer"}
                </button>
             </div>
        </div>
